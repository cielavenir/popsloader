...
PatchOffset g_600_offsets = {
	...
	.pops_patch = {
		.decomp = {
			...
			{ 0x000CC87C, 0x0000D6FC }, // 05G
			{ 0xDEADBEEF, 0xDEADBEEF }, // unused
			{ 0x000CC87C, 0x0000D6FC }, // unused
			{ 0xDEADBEEF, 0xDEADBEEF }, // unused
			{ 0x000CC87C, 0x0000D6FC }, // unused
			{ 0xDEADBEEF, 0xDEADBEEF }, // unused
			{ 0x000CC87C, 0x0000D6FC }, // unused
...
PatchOffset g_396_offsets = {
	...
	.popsman_patch = {
		...
		.sceNpDrmGetVersionKeyCall = 0xDEADBEEF,
		.scePspNpDrm_driver_9A34AC9F_Call = 0x00000138,
		.scePopsManLoadModuleCheck = 0x000014E8,
	},
	.pops_patch = {
		.decomp = {
			{ 0x000C9BF8, 0x0000FAF0 }, // 01G
			{ 0x000C9BF8, 0x0000FAF0 }, // 02G
...
PatchOffset g_393_offsets = {
	...
	.pops_patch = {
		.decomp = {
			{ 0x000B40B4, 0x0000FA7C }, // 01G
			{ 0x000B40B4, 0x0000FA7C }, // 02G
...
PatchOffset g_390_offsets = {
	...
	.pops_patch = {
		.decomp = {
			{ 0x000B4094, 0x0000FA7C }, // 01G
			{ 0x000B4094, 0x0000FA7C }, // 02G
...
PatchOffset g_380_offsets = {
	...
	.popsman_patch = {
		...
		.sceNpDrmGetVersionKeyCall = 0xDEADBEEF,
		.scePspNpDrm_driver_9A34AC9F_Call = 0x00000138,
		.scePopsManLoadModuleCheck = 0x000014E4,
	},
	.pops_patch = {
		.decomp = {
			{ 0x000B3BD8, 0x0000E518 }, // 01G
			{ 0x000B3BD8, 0x0000E518 }, // 02G
...
#ifdef CONFIG_396
   	if(fw_version == g_396_offsets.fw_version) {
		g_offs = &g_396_offsets;
	}
#endif

#ifdef CONFIG_393
   	if(fw_version == g_393_offsets.fw_version) {
		g_offs = &g_393_offsets;
	}
#endif

#ifdef CONFIG_390
   	if(fw_version == g_390_offsets.fw_version) {
		g_offs = &g_390_offsets;
	}
#endif

#ifdef CONFIG_380
   	if(fw_version == g_380_offsets.fw_version) {
		g_offs = &g_380_offsets;
	}
#endif
